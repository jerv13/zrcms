...
use Zrcms\CorePage\Api\CmsResource\CreatePageDraftCmsResource as CoreCreate;
 ...
 */
class CreatePageDraftCmsResource extends CreateCmsResource implements CoreCreate
{
    /**
