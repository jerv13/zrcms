 ...
 * @ORM\Table(
 *     name="zrcms_core_page_template_resource_history",
 *     indexes={}
 * )
 */
class PageTemplateCmsResourceHistoryEntity extends CmsResourceHistoryEntityAbstract implements CmsResourceHistoryEntity
{
    /**
     * @var int
     *
     ...
     * @param string                                          $action
     * @param PageTemplateCmsResourceEntity|CmsResourceEntity $cmsResourceEntity
