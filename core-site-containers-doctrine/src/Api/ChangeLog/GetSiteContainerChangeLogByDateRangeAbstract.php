...
namespace Zrcms\CoreSiteContainerDoctrine\Api\ChangeLog;
...
use Zrcms\CoreSiteContainer\Api\ChangeLog\GetSiteContainerChangeLogByDateRange as ParentGetChangLog;
...
class GetSiteContainerChangeLogByDateRangeAbstract extends CoreGetChangLogAbstract implements ParentGetChangLog
{
    ...
    {
        return SiteContainerCmsResourceHistoryEntity::class;
    }
    ...
    {
        return SiteContainerVersionEntity::class;
    }
    ...
    /**
     * @param SiteContainerCmsResourceHistoryEntity $historyItem
     *
     * @return ChangeLogEvent
     * @throws \Exception
     */
