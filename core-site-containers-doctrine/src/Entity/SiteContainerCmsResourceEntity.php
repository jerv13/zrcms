 ...
 * @ORM\Table(
 *     name="zrcms_core_site_container_resource",
 *     indexes={
 ...
 * )
 */
class SiteContainerCmsResourceEntity extends CmsResourceEntityAbstract implements CmsResourceEntity
{
    /**
     * @var int
     *
    ...
    /**
     * @param SiteContainerVersionEntity|ContentEntity $contentVersion
    ...
    {
        if (!$contentVersion instanceof SiteContainerVersionEntity) {
            throw new ContentVersionInvalid(
                'ContentVersion must be instance of: ' . SiteContainerVersionEntity::class
