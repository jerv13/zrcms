 ...
 */
class GetPageContainerRevisionRenderDataHtml implements GetPageContainerRevisionRenderData
{
    /**
    ...
    ): array
    {
        ...
        $renderedData[] = $pageContainerRevision->getProperty(
            PageContainerRevisionProperties::PRE_RENDERED_HTML
        );
